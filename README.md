...
lscp [-hilo] [long options...]
    ...
    --[no-]is_code                (default) Whether the input files are
                                  source code files or not
    --[no-]do_identifiers         (default) Whether to extract identifiers
    ...
    --[no-]do_lower_case          (default) Whether to convert to lower
                                  case
    --[no-]do_stemming            Whether to apply stemming
    --[no-]do_tokenize            (default) Whether to tokenize words
                                  (e.g., camelCase, under_scores)
    --[no-]do_remove_punctuation  (default) Whether to remove punctuation
    --[no-]do_remove_small_words  (default) Whether to remove small words
    --[no-]do_stopwords_english   Whether to remove English stop words
    --[no-]do_stopwords_keywords  Whether to remove programming language
                                  keywords
    --small_word_size INT         (default = 1) Size threshold for small
                                  words

    --log_level STR (or -l)       log level (debug, info, warning, error)
